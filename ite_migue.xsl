                    ...
                    <fieldset><legend><h2>Solicitud de información</h2></legend>
                        <div class="datos-per">
                            ...
                            <div>
                                ...
                                <input type="text" id="apellidos" name="apellidos" placeholder="Escribe aquí tus apellidos"/>
                            </div>
                            <div>
                                <label for="mail">Email</label>
                                <input type="email" id="mail" name="mail" placeholder="Escribe aquí tu Email"/>
                            </div>
                        </div>
                        <div class="checkbox">
